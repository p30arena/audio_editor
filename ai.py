...
def gen_cover_image(dest_folder, title, summary):
    try:
        ...
        prompt = f"Create a realistic, cover image for podcast with no alphabetic characters or text of any language, representing the following title and summary:\n\nTitle: {title}\n\nSummary: {summary}\n"
...
Don't response anything other than the correction of the transcription.
                """},
                {"role": "user", "content": text},
            ],
        )
